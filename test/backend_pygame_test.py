...
def test_pygame_audio_player_stop(audio_file: str) -> None:
    player = AudioPlayer(audio_file, 'pygame')
    player.play()
    player.stop()
    assert player._playback_backend.get_busy() == False
...
def test_pygame_audio_player_position(audio_file: str) -> None:
    player = AudioPlayer(audio_file, 'pygame')
    player.play()
    assert player.position > 0

def test_pygame_audio_player_volume(audio_file: str) -> None:
    player = AudioPlayer(audio_file, 'pygame')
